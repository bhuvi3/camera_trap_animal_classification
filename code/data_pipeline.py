...
class PipelineGenerator(object):
    ...
    def __init__(self, dataset_file, images_dir, label_name='has_animal', 
                 resize=None, **kwargs):
    ...
    def _parse_data(self, metadata, label):
        ...
        for img_name in ['image1', 'image2', 'image3']:
            img = tf.io.read_file(tf.strings.join([self._images_dir, 
                                                   metadata[img_name]])[0])
    ...
    def get_pipeline(self):
        ...
        # NOTE: Check the documentation of map for caching and other 
        # optimizations
        dataset_images = list_files.map(self._parse_data, 
